...
if __name__ == '__main__':
    ...
    items_list = [('Diesel Engine', 'A super cool diesel engine'), ('Electric Engine', 'A very quiet engine'),
                  ('ICE', 'A cheap engine')]
    engineer_list = ['ing1', 'ing2']
    man_list = ['man1']

    # System deployment
    ns = run_nameserver()
    Manager_1 = run_agent('man1', base=Manager)
    Engineer_1 = run_agent('ing1', base=Inge)
    Engineer_2 = run_agent('ing2', base=Inge)
    ...
    Engineer_1.send_msg('push_channel1', MessagesPerformative.PROPOSE)
